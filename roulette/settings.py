"""
Django settings for roulette project.
...
SECRET_KEY = 'django-insecure-ku2&_@(_za8x=*n3!-8z#r5lu-v)d)2s_c$dfbe(k(k!!_3sxr'
...
WSGI_APPLICATION = 'roulette.wsgi.application'
